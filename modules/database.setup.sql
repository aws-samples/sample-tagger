...
INSERT INTO tbprofiles (profile_id,json_profile) VALUES ('002','{"name": "Profile-Map-Tagger", "description": "Profile used for AWS MAP Program", "accounts": ["1234567890", "123456789012"], "regions": ["us-east-1", "us-east-2"], "services": ["ec2::Instance", "rds::DBInstance"], "filter": " creation_date > ''2022-01-01 00:00'' and position( ''map-migrated'' in tags ) <= 0", "tags": [{"key": "map-migrated", "value": "12345678"}], "action": "add"}');
